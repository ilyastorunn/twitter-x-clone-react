    ...
    return (
        ...
        >
            <label className="h-[2.688rem] rounded-full bg-[color:var(--background-third)] w-full relative group border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[color:var(--color-primary)]">
                <div className="w-[3.5rem] h-full flex items-center justify-center absolute top-0 left-0 pointer-event-none">
                    <svg
                        viewBox="0 0 24 24"
                ...
                <input
                    type="text"
                    placeholder="Search"
                    className="w-ful h-full bg-transparent rounded-full outline-none pl-[3.5rem]"
                    value={query}
