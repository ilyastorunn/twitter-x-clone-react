...
export default function Topic({ item }) {
    return (
        ...
        >
         ...
         <div className="text-[color:var(--color-base)] font-bold leading-5 mt-0.5">
            {item.topic.value}
         </div>
         {item?.postCount && (
